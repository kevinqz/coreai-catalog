...
Side-by-side comparison of all 39 model(s) with the `text-generation` capability.
...
| Qwen2.5 0.5B Instruct (fabric, int8) | Qwen | not_published | float16 | unknown | apache-2.0 | CoreAIRunner | — | 🐼 Zoo |
| Qwen2.5-1.5B-Instruct (fabric, int8) | Qwen | 1.5B | float16 | unknown | apache-2.0 | CoreAIRunner | — | 🐼 Zoo |
| Qwen2.5-Coder 0.5B Instruct (fabric, int8) | Qwen | not_published | float16 | unknown | apache-2.0 | CoreAIRunner | — | 🐼 Zoo |
| Qwen2.5-Coder 1.5B Instruct (fabric, int8) | Qwen | not_published | float16 | unknown | apache-2.0 | CoreAIRunner | — | 🐼 Zoo |
| Qwen2.5-Math 1.5B Instruct (fabric, int8) | Qwen | not_published | float16 | unknown | apache-2.0 | CoreAIRunner | — | 🐼 Zoo |
...
| Qwen3 1.7B (fabric, int8) | Qwen | not_published | float16 | unknown | apache-2.0 | CoreAIRunner | — | 🐼 Zoo |
...
| Qwen3-4B (fabric, int8) | Qwen | 4B | float16 | unknown | apache-2.0 | CoreAIRunner | — | 🐼 Zoo |
