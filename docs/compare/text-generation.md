...
Side-by-side comparison of all 28 model(s) with the `text-generation` capability.
...
| FastContext-1.0-4B | FastContext | 4B | int4 | iPhone/Mac | MIT | CoreAIRunner | 20.4 tokens_per_second (iPhone 17 Pro) | 🐼 Zoo |
