...
| VoxCPM-0.5B | VoxCPM | 0.5B | int8 | iPhone/Mac | Apache-2.0 | CoreAIRunner (AOT) | 0.9 frames_per_second (iPhone 17 Pro) | 🐼 Zoo |
| VoxCPM2 2B | VoxCPM | 2B | int8 | iPhone/Mac | Apache-2.0 | CoreAIRunner (AOT) | — | 🐼 Zoo |
