...
| Parakeet-TDT-0.6B | Parakeet | 0.6B | fp16 | iPhone/Mac | CC-BY-4.0 | CoreAIKit-GraphModel | 47.9 frames_per_second (iPhone 17 Pro) | 🐼 Zoo |
...
| Whisper large-v3-turbo | Whisper | 809M / ~1.5GB | fp16 | iPhone/Mac | Apache-2.0 | CoreAITranscribe | 0.18 seconds_per_token (M4 Max) | 🍎 Apple recipe |
