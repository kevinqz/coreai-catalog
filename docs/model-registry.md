...
| moss-transcribe-diarize-audio | MOSS-Transcribe-Diarize Audio Encoder (fabric) | fabric | MOSS | speech-to-text | audio | embedding | 0.9B | unknown | apache-2.0 | needs_review |
