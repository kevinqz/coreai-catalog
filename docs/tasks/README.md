...
- [Image Feature Extraction](./image-feature-extraction.md) — 5 models
- [Image Generation](./image-generation.md) — 3 models
...
- [Pii Redaction](./pii-redaction.md) — 1 models
...
- [Text To Video](./text-to-video.md) — 4 models
...
- [Vision Language Action](./vision-language-action.md) — 20 models
