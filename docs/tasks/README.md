...
- [Instance Segmentation](./instance-segmentation.md) — 6 models
...
- [Robotics](./robotics.md) — 17 models
...
- [Text Generation](./text-generation.md) — 39 models
...
- [Vision Language Action](./vision-language-action.md) — 12 models
